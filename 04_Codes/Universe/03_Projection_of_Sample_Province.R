...
proj.total <- universe.data %>% 
  ...
  select(year, quarter, date, province, city, district, pchc, market, atc4, molecule, 
         packid, sales = final_sales)

write_feather(proj.total, '03_Outputs/Universe/03_Bluebook_2020_Universe_Projection_of_Sample_Province.feather')
